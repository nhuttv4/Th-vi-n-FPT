...
Bạn ấn tượng nhất với chi tiết hoa văn nào trên Trống đồng Đông Sơn? Cùng chia sẻ với cộng đồng nhé!`,
  ...
  {
    id: 'post_pending_1',
    title: 'Góc học tập: Sơ đồ tư duy so sánh ba lần Kháng chiến chống Nguyên Mông (1258, 1285, 1288)',
    content: `Chào Thầy Cô và các bạn trong Thư viện Lịch sử FPT,
    
Em là Nhựt TV, học sinh khối 12. Em vừa vẽ xong sơ đồ tổng hợp so sánh lực lượng, kế sách đánh giặc (Vườn không nhà trống) và các trận đánh then chốt (Đông Bộ Đầu, Hàm Tử, Chương Dương, Tây Kết, Vạn Kiếp, Bạch Đằng) trong 3 lần Đại phá quân Mông - Nguyên thời nhà Trần.

Em xin phép gửi bài lên diễn đàn để các Thầy Cô góp ý và chia sẻ cho các bạn cùng khối ôn tập tốt nghiệp THPT ạ!`,
    category: 'academic',
    grade: '12',
    authorId: 'u_nhuttv4',
    authorName: 'Nhựt TV',
    authorRole: 'student',
    authorAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
    coverImage: 'https://images.unsplash.com/photo-1599839575945-a9e5af0c3fa5?w=1200&auto=format&fit=crop&q=80',
    attachedDocIds: ['doc_16'],
    tags: ['Hào khí Đông A', 'Thời Trần', 'Sơ đồ tư duy', 'Học sinh FPT'],
    isPinned: false,
    status: 'pending',
    likesCount: 0,
    commentsCount: 0,
  ...
  {
    id: 'post_pending_2',
    title: 'Thảo luận: Ý nghĩa chiến lược của Hội nghị Hiệp thương chính trị thống nhất hai miền (11/1975)',
    content: `Kính gửi Tổ Lịch sử FPT,

Sau đại thắng mùa Xuân 1975, Hội nghị Hiệp thương chính trị họp tại Sài Gòn đã quyết định thống nhất nước nhà về mặt nhà nước. Bài viết này trình bày chi tiết về cuộc Tổng tuyển cử bầu Quốc hội khóa VI chung của cả nước ngày 25/4/1976. Kính mong Ban Quản trị phê duyệt để em cùng thảo luận với các bạn.`,
    category: 'discussion',
    grade: '12',
    authorId: 'u_student_thcs',
    authorName: 'Học sinh THCS FPT',
    authorRole: 'student',
    authorAvatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&auto=format&fit=crop&q=80',
    attachedDocIds: ['doc_2'],
    tags: ['Lịch sử 12', 'Thống nhất đất nước', '1975-1976'],
    isPinned: false,
    status: 'pending',
    likesCount: 0,
    commentsCount: 0,
