...
Hào khí Đông A (chữ "Trần" gồm bộ Phụ và chữ Đông, chữ A ghép lại) chính là kết tinh của lòng yêu nước nồng nàn, ý chí tự cường bất khuất và tinh thần đại đoàn kết quân dân: "Vua tôi đồng lòng, anh em hòa thuận, cả nước góp sức".`,
  ...
  {
    id: 'doc_pending_1',
    title: 'Sơ đồ tư duy & Tóm tắt Lịch sử 12: 56 Ngày Đêm Chiến dịch Điện Biên Phủ (1954)',
    description: 'Học liệu do học sinh Nhựt TV tổng hợp: Phân tích quyết định chuyển phương châm tác chiến từ "Đánh nhanh thắng nhanh" sang "Đánh chắc tiến chắc" của Đại tướng Võ Nguyên Giáp, 3 đợt tiến công đồi Him Lam, Độc Lập, A1 và bắt sống tướng Đờ Cát.',
    type: 'outline',
    category: 'vietnam',
    grade: '12',
    subject: 'Lịch sử 12',
    ...
    fileUrl: '/docs/so-do-dien-bien-phu-1954.pdf',
    thumbnailUrl: 'https://images.unsplash.com/photo-1577495508048-b635879837f1?w=600&auto=format&fit=crop&q=80',
    fileType: 'pdf',
    fileSize: '3.4 MB',
    pagesCount: 8,
    tags: ['Điện Biên Phủ', '1954', 'Sơ đồ tư duy', 'Võ Nguyên Giáp', 'GDPT 2018'],
    status: 'pending',
    viewCount: 1,
    downloadCount: 0,
    likesCount: 0,
  ...
  {
    id: 'doc_pending_2',
    title: 'Chuyên khảo tham khảo: Văn minh Đại Việt thời Lê Sơ & Bộ Quốc Triều Hình Luật (Luật Hồng Đức)',
    description: 'Tài liệu tham khảo chuyên sâu nghiên cứu về chế độ quân chủ chuyên chế trung ương tập quyền cao độ dưới triều vua Lê Thánh Tông, tổ chức thi cử khoa cử Nho học và các điều luật tiến bộ bảo vệ quyền lợi phụ nữ trong Luật Hồng Đức.',
    type: 'ebook',
    category: 'civilization',
    grade: '10',
    subject: 'Lịch sử 10',
    ...
    fileUrl: '/docs/van-minh-thoi-le-so-luat-hong-duc.pdf',
    thumbnailUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&auto=format&fit=crop&q=80',
    fileType: 'docx',
    fileSize: '4.8 MB',
    pagesCount: 24,
    tags: ['Thời Lê Sơ', 'Luật Hồng Đức', 'Lê Thánh Tông', 'Văn minh Đại Việt'],
    status: 'pending',
    viewCount: 1,
    downloadCount: 0,
    likesCount: 0,
